      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5
            ...
            focus:ring-indigo-500 transition pr-10"
        />
        {isPassword && (
...
export default function Settings() {
  ...
  useEffect(() => {
    settingsAPI.getProfile().then(r => {
      setProfile({ fullName: r.data.fullName, email: r.data.email });
    }).catch(() => {});
  }, []);
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      setPasswordMsg({ type: 'success', text: 'Password changed! Logging you out...' });
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {/* Account Info */}
      <Section icon={User} title="Account Info" subtitle="Your account details"
        ...
        {!showDeleteSection ? (
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="text-slate-500 text-xs mt-0.5">
                Permanently delete your account and all surveys. This cannot be undone.
              </p>
            </div>
            <button onClick={() => setShowDeleteSection(true)}
              className="flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium
                border border-red-500/30 text-red-400 hover:bg-red-500/10 transition">
          ...
          <div className="space-y-4">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              <p className="text-red-400 text-sm font-semibold mb-1">⚠️ This action is permanent</p>
              <p className="text-red-300/70 text-xs">
                All your surveys, questions, and responses will be deleted forever with no way to recover.
              </p>
            </div>
            <div>
              ...
              <input type="text" value={deleteConfirmText}
                ...
                className="w-full bg-slate-800 border border-red-500/30 rounded-lg px-4 py-2.5
                  text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500 transition" />
            </div>
