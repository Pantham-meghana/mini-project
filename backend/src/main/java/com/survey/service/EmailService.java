...
/**
 * Sends a beautiful HTML confirmation email to the survey respondent.
...
public class EmailService {
    ...
    public void sendResponseConfirmation(String toEmail, Survey survey, Response response) {
        try {
            ...
            helper.setText(buildEmailHtml(survey, response), true);
    ...
    private String buildEmailHtml(Survey survey, Response response) {
        ...
        sb.append("""
            <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8fafc;padding:20px;">
              <div style="background:#4f46e5;padding:24px;border-radius:12px 12px 0 0;text-align:center;">
                ...
                <p style="color:#c7d2fe;margin:6px 0 0 0;">Response Confirmation</p>
              </div>
        ...
        sb.append("""
                ...
                <p style="color:#94a3b8;font-size:13px;">Submitted on: """);
        sb.append(response.getSubmittedAt()
                .format(DateTimeFormatter.ofPattern("dd MMM yyyy, hh:mm a")));
        sb.append("""
                </p>
                <h3 style="color:#1e293b;border-bottom:2px solid #e2e8f0;padding-bottom:8px;">Your Answers</h3>
        ...
        for (Answer answer : response.getAnswers()) {
            ...
            sb.append("<tr><td style=\"padding:10px;vertical-align:top;border-bottom:1px solid #f1f5f9;\">")
              .append("<p style=\"margin:0;color:#64748b;font-size:11px;text-transform:uppercase;letter-spacing:0.5px;\">")
              .append(q.getQuestionType().name()).append("</p>")
              .append("<p style=\"margin:4px 0 0;color:#1e293b;font-weight:600;\">").append(q.getText()).append("</p>")
              .append("<p style=\"margin:6px 0 0;color:#4f46e5;\">").append(answerText).append("</p>")
              .append("</td></tr>");
        }
    ...
    private String getAnswerText(Answer answer, Question q) {
        return switch (q.getQuestionType()) {
            ...
            case TEXT   -> answer.getTextAnswer() != null && !answer.getTextAnswer().isBlank()
